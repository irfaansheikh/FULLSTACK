...
if ( ! function_exists( 'pelicula_get_filter_items' ) ) {
	/**
	 ...
	 * @return array
	 */
	function pelicula_get_filter_items( $params ) {
		...
		return apply_filters( 'pelicula_filter_get_filter_items', $items, $params );
	}
}