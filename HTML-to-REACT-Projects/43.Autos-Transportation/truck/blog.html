...
<html>
<head>
<title>Truck a Transport Category Flat Bootstarp responsive Website Template| Blog :: w3layouts</title>
			...
			<div class="header">
				...
				<div class="top-nav">
					...
					<ul class="nav1">
						...
						<li class="hvr-sweep-to-bottom active"><a href="blog.html">Blog<i><img src="images/nav-but4.png" alt=""/></i></a></li>
