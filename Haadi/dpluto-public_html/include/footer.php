		...
		<div class="row">
			<div class="col-lg-3 col-md-6 col-sm-6">
				<div class="footer-contact">
					...
					<h3>Get in Touch</h3>
					<a href="<?php echo PHONE_HREF ?>"><i class="fas fa-phone"></i> <?php echo '92 313 4888 000' ?> (PAK)</a>
		...
		<div class="row justify-content-between">
			...
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="soical-right">
					<ul>
						<li><a href="https://wa.me/923134888000" target="blank"><i class="fab fa-whatsapp"></i><span></span></a></li>
						<li><a href="https://linkedin.com/DPlutoTech" target="blank"><i class="fab fa-facebook-f"></i><span></span></a></li>
						<li><a href="https://instagram.com/DPlutoTech" target="blank"><i class="fab fa-instagram"></i><span></span></a></li>
						<li><a href="https://twitter.com/DPlutoTech" target="blank"><i class="fab fa-twitter"></i><span></span></a></li>
						<li><a href="https://linkedin.com/DPlutoTech" target="blank"><i class="fab fa-linkedin-in"></i><span></span></a></li>
						<li><a href="https://youtube.com/DPlutoTech" target="blank"><i class="fab fa-youtube"></i><span></span></a></li>
