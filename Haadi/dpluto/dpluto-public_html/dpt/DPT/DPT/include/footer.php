		...
		<div class="row">
			<div class="col-lg-3 col-md-6 col-sm-6">
				<div class="footer-contact">
					...
					<h3>Get in Touch</h3>
					<a href="<?php echo PHONE_HREF ?>"><i class="fas fa-phone"></i> <?php echo PHONE ?> (USA)</a>
					<a href="<?php echo EMAIL_HREF ?>"><i class="fas fa-envelope-open-text"></i> <?php echo EMAIL ?></a>
					<a href="javascript:;"><i class="fas fa-map-marked-alt"></i> <?php echo ADDRESS ?></a>
				</div>
			</div>
